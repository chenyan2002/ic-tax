...
module {
  ...
  public type Result_3 = { #Ok : NeuronInfo; #Err : GovernanceError };
  ...
  public type RewardNodeProviders = { rewards : [RewardNodeProvider] };
  ...
  public type Self = actor {
    ...
    get_neuron_info : shared query Nat64 -> async Result_3;
    get_neuron_info_by_id_or_subaccount : shared query NeuronIdOrSubaccount -> async Result_3;
    ...
    update_node_provider : shared query UpdateNodeProvider -> async Result;
  }
}
